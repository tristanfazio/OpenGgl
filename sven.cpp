 ...
 * DATE: 10/19
 * PURPOSE: draw a series of box object representing sven in the world scene
 **********************************************/
...
void drawSven(unsigned int texture, glm::mat4 view, glm::mat4 projection,glm::vec3 cameraPos,bool svenEquipped)
{
    ...
    //(4 tall boxes for legs & body)
		glm::vec3 sven_scales[] = {
			...
			glm::vec3( 0.05f,  0.05f,  0.05f),	//ear
			glm::vec3( 0.1f,  0.05f,  0.1f)	//snout
		};
		glm::vec3 sven_positions[] = {
			...
			glm::vec3(-0.075f, 0.45f,  0.2f),	//ear
			glm::vec3(0.0f, 0.3f,  0.25f)	//snout
		};
		...
		{	
            ...
            shader.setVec4("ourColor",glm::vec4(0.973f, 0.973f, 1.0f,1.0f));
